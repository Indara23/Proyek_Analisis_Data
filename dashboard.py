...
if filtered_df.empty:
    ...
    sns.barplot(x="weather_label", y="cnt", data=weather_avg, palette=colors, ax=ax)
    ax.set_xlabel("Cuaca")
    ...
    fig, ax = plt.subplots(figsize=(10, 5))
    sns.barplot(x="season_label", y="cnt", data=season_avg, palette=colors, ax=ax)
    ax.set_xlabel("Musim")
    ax.set_ylabel("Rata-rata Jumlah Penyewaan")
    st.pyplot(fig)
    ...
    # Perbandingan Rata-rata Penyewaan Sepeda pada Hari Kerja dan Hari Libur
    st.subheader("Perbandingan Rata-rata Penyewaan Sepeda pada Hari Kerja dan Hari Libur")
    ...
    fig, ax = plt.subplots(figsize=(10, 6))
    sns.barplot(x="weekday", y="cnt", data=avg_rent_per_day, palette=colors, ax=ax)
    ax.set_xlabel("Hari")
    ax.set_ylabel("Rata-rata Jumlah Penyewaan")
    st.pyplot(fig)
